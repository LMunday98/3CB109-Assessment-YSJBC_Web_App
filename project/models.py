...
def seed():
    ...
    try:
        ...
        Event.create("Yoga", "event-4", datetime.date(2021, 4, 12), datetime.time(14, 00), datetime.time(15, 00))
        # Tuesday
        Event.create("Weight Training", "event-3", datetime.date(2021, 4, 13),  datetime.time(12, 30), datetime.time(14, 0))
        Event.create("Yoga", "event-4", datetime.date(2021, 4, 13),  datetime.time(14, 30), datetime.time(15, 30))
        # Wednesday
        Event.create("Water Session", "event-1", datetime.date(2021, 4, 14),  datetime.time(9, 30), datetime.time(12, 30))
        Event.create("Water Session", "event-1", datetime.date(2021, 4, 14),  datetime.time(13, 30), datetime.time(16, 30))
        # Thursday
        Event.create("Erg", "event-2", datetime.date(2021, 4, 15),  datetime.time(15, 30), datetime.time(16, 30))
